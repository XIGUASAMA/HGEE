function [ repulsion] = compute_repulsion_ob(robot_pose,obs_pose, obs_radii, detect_R)
...
for i=1:M
    ...
    distance=sqrt((robot_pose(1)-obs_pose(i,1))^2+(robot_pose(2)-obs_pose(i,2))^2) - obs_radii(i);
